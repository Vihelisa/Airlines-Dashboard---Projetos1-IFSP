...
df_emp_filtro = df_emp_filtro.fillna(0)
...
""")
df_emp_filtro.loc[:, 'coef_lucratividade'] = df_emp_filtro['rpk']/df_emp_filtro['ask']
df_lucratividade = df_emp_filtro[['aeroporto_de_origem_nome', 'aeroporto_de_destino_nome', 'mes', 'ano', 'coef_lucratividade']]
...
if 'Todos' in ano_selecionado:
    ...
    df_lucratividade_groupby_mes = df_emp_filtro[['aeroporto_de_origem_nome', 'aeroporto_de_destino_nome', 'mes', 'ano', 'coef_lucratividade']]
