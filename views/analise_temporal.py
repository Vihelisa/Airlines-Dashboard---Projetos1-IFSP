...
df_sazonal = df_emp_filtro[lista]
df_sazonal_sem_groupby = df_emp_filtro[lista]

#df_sazonal = df_sazonal.select_dtypes(include=['number'])
df_sazonal = df_sazonal.fillna(0)
